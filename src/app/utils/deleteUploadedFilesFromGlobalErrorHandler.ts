...
export const deleteUploadedFilesFromGlobalErrorHandler = async (req: Request & { file?: Express.Multer.File; files?: Express.Multer.File[] | { [fieldname: string]: Express.Multer.File[] } }) => {
    try {
