...
export const createDoctorZodSchema =z.object({
    ...
    doctor: z.object({
        ...
        experience: z.number("experience is required").nonnegative("experience must be a non-negative number"),
    ...
    Specialties: z.array(z.string(), "specialties must be an array of strings").min(1, "at least one specialty is required")
})